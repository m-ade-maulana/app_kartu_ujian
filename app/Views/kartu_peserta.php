            ...
            <div class="card" id="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-sm-2"><span>Nomor Peserta</span></div>
                                <div class="col-sm-8"><span>: <?= $id_peserta ?></span></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2"><span>Nama Peserta</span></div>
                                <div class="col-sm-8"><span>: <?= $nama ?></span></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2"><span>Kelas</span></div>
                                <div class="col-sm-8"><span>: <?= $kelas ?></span></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-2"><span>Ruangan</span></div>
                                <div class="col-sm-8"><span>: <?= $ruangan ?></span></div>
                            </div>
                            <div class="d-grid gap-2 mt-2">
                                <?php
                                if ($legitimasi_projek == 'no' && $legitimasi_teori == 'no') { ?>
                                ...
                                <?php } else if ($legitimasi_projek == 'yes' && $legitimasi_teori == 'no') { ?>
                                    <a href="#" target="_blank" class="btn btn-primary fw-bold">Cetak Kartu legitimasi Projek</a>
                                    <a href="#" target="_blank" class="btn btn-secondary fw-bold" tabindex="-1">Cetak Kartu Legitimasi Teori</a>
                                <?php } else { ?>
                                    <a href="<?= site_url('/cetak_kartu_legitimasi_projek') ?>" target="_blank" class="btn btn-primary fw-bold">Cetak Kartu legitimasi Projek</a>
                                    <a href="#" target="_blank" class="btn btn-primary fw-bold">Cetak Kartu Legitimasi Teori</a>
                                <?php }
                                ?>
                            </div>
                        </div>
